...
|--------------|-----------------------------------|----------------------------|------------------------------|
| TERMOCICLADOR EN TIEMPO REAL miniPCR® mini16|Es un dispositivo de laboratorio potente y asequible para copiar material genético (ADN). La miniPCR tiene espacio para hasta 16 muestras. Este dispositivo se puede controlar y programar mediante una aplicación gratuita en su celular o computadora. Se puede conectar mediante Bluetooth o USB. No es necesario mantener el dispositivo conectado a la computadora, tableta o celular para ejecutar el programa.|![](https://www.minipcr.com/wp-content/uploads/DSC_0234-1-450x450.png)| 790 € (s/ 3 1355. 64) |
...
|--------------|-----------------------------------|----------------------------|
| Arduino PCR |Es un termociclador muy económico pero preciso que se puede construir con pocos pasos y materiales muy accesibles y populares, este dispositivo utiliza un Arduino Mini. Tiene un costo de construcción de 85 USD.|![](https://content.instructables.com/FMX/HYHA/H4AGJRQD/FMXHYHAH4AGJRQD.jpg?auto=webp&frame=1&width=1024&height=1024&fit=bounds&md=27f98a737779d150ccb8fd76958b5378)|
